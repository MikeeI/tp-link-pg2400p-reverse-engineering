...
- `js/su/frame.js`@42905: default model read assigns `GET` and `$.su.url("", data)`; client supplies requested configuration keys as form fields.
- `js/su/frame.js`@52231: writes use `POST`; do not use for this read-only lane.
- `js/app/url.js`@579: session key literal is `_t`; the builder appends it to the relative root URL when a session exists.
- `js/su/frame.js`@48352: response parser recognizes `ERROR=<decimal>` followed by CR/LF-separated `KEY=VALUE` records; it excludes the `ERROR` record from parsed data and splits each line at its first `=`.
...
## Authentication clue
- [confirmed] `modules/login/localLogin/controllers.js`@826 applies `md5()` to the entered password before delegating login. `modules/login/localLogin/models.js`@276 writes the result as `TPLINK.GENERAL.LOGIN_PASSWORD` through `MERProxyNew`. This proves the client-side flow, not server-side password storage or an authenticated request transcript.

## Web UI/update route
- [confirmed] `modules/advanced/system/firmware/models.js`@279 declares `COMMAND=firmware upgrade`; its controller checks `.ftp` and calls Ajax upload @1325. This is mutation-risking and excluded from the CLI.
...
- `AFE.GENERAL.ID`: web/modules/powerLine/compatibilityMode/models.js@285
- `CLOCK.GENERAL.TIME_ZONE`: web/modules/advanced/system/timeSettings/models.js@102
- `DHCP.GENERAL.ENABLED_IPV4`: web/modules/advanced/network/lanAdv/script.js@4751, web/modules/networkMap/mapRepeater/models.js@1010
- `DHCP.GENERAL.ENABLED_IPV6`: web/modules/advanced/network/lanAdv/script.js@5147, web/modules/networkMap/mapRepeater/models.js@1266
...
- `DNS.GENERAL.IPV4`: web/modules/advanced/network/lanAdv/script.js@5051
- `DNS.GENERAL.IPV6`: web/modules/advanced/network/lanAdv/script.js@5712
...
- `PHYMNG.GENERAL.RUNNING_PHYMODE_ID`: web/modules/powerLine/compatibilityMode/models.js@511
...
- `TCPIP.IPV4.GATEWAY`: web/modules/advanced/network/lanAdv/script.js@4949, web/modules/networkMap/mapRepeater/models.js@1323
- `TCPIP.IPV4.IP_ADDRESS`: web/modules/advanced/network/lanAdv/script.js@4799, web/modules/networkMap/mapRepeater/models.js@1160
- `TCPIP.IPV4.IP_NETMASK`: web/modules/advanced/network/lanAdv/script.js@4870, web/modules/networkMap/mapRepeater/models.js@1213
- `TCPIP.IPV6.GATEWAY`: web/modules/advanced/network/lanAdv/script.js@5655
- `TCPIP.IPV6.IP_ADDRESS`: web/modules/advanced/network/lanAdv/script.js@5535
- `TCPIP.IPV6.IP_PREFIX`: web/modules/advanced/network/lanAdv/script.js@5595
- `TCPIP.IPV6.LINK_LOCAL_IP_ADDRESS`: web/modules/networkMap/mapRepeater/models.js@1373
- `TCPIP.IPV6.SLAAC_IP_ADDRESS`: web/modules/networkMap/mapRepeater/models.js@1435
- `TPLINK.GENERAL.INCREASE_CONTRAST`: web/modules/advanced/system/a11y/models.js@88
- `TPLINK.GENERAL.LANGUAGE`: web/models/commonModels.js@375, web/modules/main/models.js@87
...
- `TR064.GENERAL.DETECTED`: web/modules/powerLine/compatibilityMode/models.js@402
- `TR064.GENERAL.ENABLE`: web/modules/powerLine/compatibilityMode/models.js@164

## Literal `COMMAND` instruction strings
- `change password`: `web/modules/advanced/system/changeLoginPassword/models.js`@927
- `get time`: `web/modules/advanced/system/timeSettings/models.js`@1608
- `set time `: `web/modules/advanced/system/timeSettings/models.js`@1655
- `get time`: `web/modules/index/script.js`@8350
- `is factorydefault`: `web/modules/main/main.js`@472
- `logout`: `web/modules/main/main.js`@3202
- `plc remove `: `web/modules/networkMap/mapInternet/controllers.js`@2283
- `lan link speed`: `web/modules/networkMap/mapRepeater/controllers.js`@571
- `get compatibility mode`: `web/modules/powerLine/compatibilityMode/models.js`@1042
- `set compatibility mode `: `web/modules/powerLine/compatibilityMode/models.js`@1103
- `reset powerline`: `web/modules/powerLine/powerLineSetting/controllers.js`@517
- `plc leave network`: `web/modules/powerLine/softPair/controllers.js`@1309
- `get qos`: `web/modules/qos/models.js`@394
- `set qos `: `web/modules/qos/models.js`@440
