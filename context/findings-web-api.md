...
- [unresolved] No server-handler xref connects the 1.1.0 client mappings to raw `webserver.c`; raw Xtensa image base, entry point, and function references remain necessary to prove server-side ownership and write semantics.
